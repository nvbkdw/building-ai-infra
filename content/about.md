...
* Build large-scale distributed inference system deployed across multiple cloud providers.
* Optimize inference engine with KV cache store, SGLang, dynamic batching, and quantization.
* Develop custom CuTeDSL/CUTLASS kernel libraries for both training and inference workloads.
